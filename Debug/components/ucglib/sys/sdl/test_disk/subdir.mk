...
C_SRCS += \
../components/ucglib/sys/sdl/test_disk/main.c 

OBJS += \
./components/ucglib/sys/sdl/test_disk/main.o 

C_DEPS += \
./components/ucglib/sys/sdl/test_disk/main.d 


# Each subdirectory must supply rules for building sources it contributes
components/ucglib/sys/sdl/test_disk/%.o: ../components/ucglib/sys/sdl/test_disk/%.c
	@echo 'Building file: $<'
