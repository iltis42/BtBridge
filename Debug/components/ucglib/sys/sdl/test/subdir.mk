...
C_SRCS += \
../components/ucglib/sys/sdl/test/main.c 

OBJS += \
./components/ucglib/sys/sdl/test/main.o 

C_DEPS += \
./components/ucglib/sys/sdl/test/main.d 


# Each subdirectory must supply rules for building sources it contributes
components/ucglib/sys/sdl/test/%.o: ../components/ucglib/sys/sdl/test/%.c
	@echo 'Building file: $<'
