...
C_SRCS += \
../components/ucglib/sys/tga/examples/main.c 

OBJS += \
./components/ucglib/sys/tga/examples/main.o 

C_DEPS += \
./components/ucglib/sys/tga/examples/main.d 


# Each subdirectory must supply rules for building sources it contributes
components/ucglib/sys/tga/examples/%.o: ../components/ucglib/sys/tga/examples/%.c
	@echo 'Building file: $<'
